...
var _injectAce = require('./injectAce');

var _injectAce2 = _interopRequireDefault(_injectAce);
...
var ReactAce = exports.ReactAce = function (_React$Component) {
    _inherits(ReactAce, _React$Component);
    ...
    _createClass(ReactAce, [{
        ...
        value: function handleMarkers(markers) {
            ...
            var _props$ace$require = this.props.ace.require('ace/range'),
                Range = _props$ace$require.Range;
        ...
        value: function render() {
            ...
            return _react2.default.createElement('div', { ref: 'editor', id: name, style: divStyle });
        }
    }]);
...
ReactAce.propTypes = {
    ace: _propTypes2.default.object,
...
exports.default = (0, _injectAce2.default)(ReactAce);